...
use winapi::um::winnt::{CONTEXT, MEMORY_BASIC_INFORMATION, PAGE_EXECUTE, PAGE_EXECUTE_READ, PAGE_EXECUTE_READWRITE, PAGE_EXECUTE_WRITECOPY, PAGE_NOACCESS, PAGE_READONLY, PAGE_READWRITE, PAGE_WRITECOPY, WOW64_CONTEXT};
...
fn get_size(arg: &[&str], h_proc: HANDLE, addr: u64) -> Result<usize, String>{
    if arg.len() == 3 {
        ...
        unsafe {
            ...
            if VirtualQueryEx(h_proc, addr as LPVOID, &mut mem_info, std::mem::size_of::<MEMORY_BASIC_INFORMATION>()) == 0 {
